...
def create_concept_map():
    ...
    files = [
        "queue_worker.py", "inventory_scanner.py", "Gen_1_Evolution.md", 
        "Blackboard_Protocol.json", "Critic_Agent.py", "Molt_Script.sh"
    ]
...
if __name__ == "__main__":
    try:
        ...
        print("Missing libraries for visualization. Please install matplotlib and networkx.")
        print(f"Error: {e}")
