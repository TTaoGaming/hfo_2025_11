...
hexagon:
  ontos:
    id: 5af46cc8-033d-4eb5-9eee-9bd7074f5883
    type: md
    owner: Swarmlord
  chronos:
    status: active
    urgency: 0.5
    decay: 0.5
    created: '2025-11-23T11:07:35.912682Z'
    generation: 51
  topos:
    address: eyes/archive/hfo_gem/gen_25/vision_gem_gene_seed_regeneration_2025-11-06.md
    links: []
  telos:
    viral_factor: 0.0
