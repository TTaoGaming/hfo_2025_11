...
# hexagon:
#   ontos:
#     id: 5ac913c0-3170-4712-9bd4-044bd848f2a5
#     type: feature
#     owner: Swarmlord
#   chronos:
#     status: active
#     urgency: 0.5
#     decay: 0.5
#     created: '2025-11-23T11:06:49.835339Z'
#     generation: 51
#   topos:
...
summary: Feature specification for a persistent asynchronous blackboard system enabling
  decoupled agent coordination through heartbeats, missions, consensus voting, disruptor
  handling, and architectural visualization.
