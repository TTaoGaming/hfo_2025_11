...
summary: The Obsidian Hourglass is an anytime decision-making algorithm that enables
  the Swarmlord to balance past precedents from the Karmic Web and future simulations
  from the Simulation Web to select optimal paths under time or budget constraints.
domain: Strategy
concepts:
- Obsidian Hourglass
- Karmic Web
