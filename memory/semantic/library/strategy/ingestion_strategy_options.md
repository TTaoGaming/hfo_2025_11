---
title: 'HFO Gem Ingestion Strategy: 4 Viable Options'
summary: Outlines four composable options for migrating HFO Gems from archive to semantic
  memory, recommending Option 2 (The Taxonomist) for LLM-driven metadata extraction
  as the optimal starting point.
domain: Strategy
concepts:
- Ingestion Pipeline
- Semantic Tagging
...
actionable: true
related_files:
- memory/semantic/graph_edges.jsonl
type: crystallized_memory
status: active
last_verified: '2025-11-21'
hexagon:
  ontos:
    id: 365808dd-5e78-49b2-a8ce-c524e9737c96
    type: md
    owner: Swarmlord
  chronos:
    status: active
    urgency: 0.5
    decay: 0.5
    created: '2025-11-23T10:21:10.283274+00:00'
    generation: 51
  topos:
    address: memory/semantic/library/strategy/ingestion_strategy_options.md
    links: []
  telos:
    viral_factor: 0.0
