---
title: The Brain (Navigator) - Strategy and Intent Hub
summary: The Brain module defines high-level strategic intent and specifications for
  the Hive Fleet Obsidian system, housing Gherkin feature files, the central registry,
  and system anatomy maps.
domain: Strategy
concepts:
- Navigator
- Intent
