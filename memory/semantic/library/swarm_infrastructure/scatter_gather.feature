...
# hexagon:
#   ontos:
#     id: 1d696920-7eec-4cec-a780-359e77e2e847
#     type: feature
#     owner: Swarmlord
#   chronos:
#     status: active
#     urgency: 0.5
#     decay: 0.5
#     created: '2025-11-23T10:21:10.380864+00:00'
#   topos:
...
summary: Gherkin specification for the Swarmlord to dispatch heterogeneous cohorts
  of AI agents via Ray for parallel task execution using the PREY Loop, aggregating
  results through Nerves and Assimilator into Memory.
domain: Swarm Infrastructure
concepts:
- Scatter-Gather
- Hydra Pattern
- Swarmlord
