---
title: HFO Tri-Brain Memory Architecture (Draft)
summary: Proposed Tri-Brain architecture mimicking biological memory consolidation
  with Scribe (surface hygiene), Stream (fast vector recall), and Graph (deep relational
  wisdom) layers for a hierarchical Hive Mind memory system.
domain: Memory
concepts:
- Tri-Brain Architecture
- Stigmergic Artifacts
- GraphRAG
- pgvector
- NATS JetStream
owner: Architect
