...
hexagon:
  ontos:
    id: b944f641-c563-40b3-b55b-e6a25ef18bbd
    type: md
    owner: Swarmlord
  chronos:
    status: active
    urgency: 0.5
    decay: 0.5
    created: '2025-11-23T10:21:11.956118+00:00'
    generation: 51
  topos:
    address: memory/missions/20251121_041348_95eef55a/squads/Sq-1/agents/Sq-1-Ag3/round_1_audit.md
    links: []
  telos:
    viral_factor: 0.0
