...
hexagon:
  ontos:
    id: 20c20cb5-d174-40ee-876e-f235bc9a84e6
    type: md
    owner: Swarmlord
  chronos:
    status: active
    urgency: 0.5
    decay: 0.5
    created: '2025-11-23T10:21:11.939696+00:00'
    generation: 51
  topos:
    address: memory/missions/20251121_041348_95eef55a/squads/Sq-1/squad_report.md
    links: []
  telos:
    viral_factor: 0.0
...
- LangGraph/CrewAI 2025: failure rates slashed 70%→15%, verified benchmarks (Conf: 0.94)
