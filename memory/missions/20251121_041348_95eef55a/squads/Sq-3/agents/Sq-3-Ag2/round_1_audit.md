...
hexagon:
  ontos:
    id: dd9be1b1-9d28-4587-9a58-95a794b380d8
    type: md
    owner: Swarmlord
  chronos:
    status: active
    urgency: 0.5
    decay: 0.5
    created: '2025-11-23T10:21:11.971591+00:00'
  topos:
    address: memory/missions/20251121_041348_95eef55a/squads/Sq-3/agents/Sq-3-Ag2/round_1_audit.md
    links: []
  telos:
    viral_factor: 0.0
