...
class Settings(BaseSettings):
    ...
    langchain_project: str = Field("hive-fleet-obsidian-gen50", alias="LANGCHAIN_PROJECT")
...
try:
    ...
    print(f"⚠️ Warning: Configuration not fully loaded. Check .env and models.yaml. Error: {e}")
    settings = None
    model_registry = None
