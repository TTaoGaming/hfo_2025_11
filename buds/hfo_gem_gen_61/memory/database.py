...
from buds.hfo_gem_gen_61.blood.schema import MemoryItem, Level0Artifact, Level1Artifact, Level2Artifact
...
class IronLedger:
    ...
    """
    def __init__(self, db_path: str = "buds/hfo_gem_gen_61/memory/hfo_gen_61_memory.db"):
