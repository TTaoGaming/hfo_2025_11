...
# This assumes the file is located at buds/hfo_gem_gen_56/memory/unified_memory.py
# We need to go up 3 levels: memory -> hfo_gem_gen_56 -> buds -> root
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../../..")))

from hfo_sdk.stigmergy import StigmergyClient
from buds.hfo_gem_gen_56.memory.lancedb_store import HFOStigmergyMemory
...
class UnifiedMemorySystem:
    ...
    """
    def __init__(self, nats_url="nats://localhost:4225", lancedb_path="buds/hfo_gem_gen_56/memory/lancedb"):
