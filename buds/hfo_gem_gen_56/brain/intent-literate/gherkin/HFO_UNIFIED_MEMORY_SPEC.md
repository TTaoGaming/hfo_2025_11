...
- buds/hfo_gem_gen_56/HFO_UNIFIED_MEMORY_SPEC.md: defines
tags:
- architecture
- stigmergy
- memory
...
octagon:
  ...
  topos:
    address: buds/hfo_gem_gen_56/brain/intent-literate/gherkin/HFO_UNIFIED_MEMORY_SPEC.md
    links: []
  telos:
    viral_factor: 1.0
...
1.  **Initialize Buds**: Ensure `buds/hfo_gem_gen_56` is the cleanroom root.
