...
from buds.hfo_gem_gen_59.blood.schema import Level0Artifact, Level1Artifact, Level2Artifact, MemoryItem
...
class PreySwarm:
    ...
    def _load_config(self) -> Dict:
        ...
        try:
            with open("buds/hfo_gem_gen_59/memory/weekly_champions.json", "r") as f:
                config = json.load(f)
