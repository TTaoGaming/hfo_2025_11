...
from buds.hfo_gem_gen_59.brain.oracle import Oracle
...
class TestOracle(unittest.TestCase):
    ...
    def test_oracle_retrieval(self):
        ...
        # 3. Ask Oracle
        oracle = Oracle(lancedb_path=self.test_lancedb_path)
        ...
        print("✅ Test Passed: Oracle retrieved correct memories.")
