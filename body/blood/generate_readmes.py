...
ORGANS = {
    "brain": {
        "icon": "🧠", "name": "The Brain", "role": "Navigator / Strategist",
        "jadc2": "Commander (C2)", "gherkin": "`brain/gen50_core.feature`",
    ...
    "eyes": {
        "icon": "👁️", "name": "The Eyes", "role": "Observer / Sensor",
        "jadc2": "Sensor", "gherkin": "`brain/prey_workflow.feature`",
    ...
    "body": {
        "icon": "🦾", "name": "The Body", "role": "The Swarm / Executor",
        "jadc2": "Decider / Effector", "gherkin": "`brain/swarm_workflow.feature`",
    ...
    "body/nerves": {
        "icon": "⚡", "name": "The Nerves", "role": "Bridger / Communicator",
        "jadc2": "Communicator", "gherkin": "`brain/stigmergy_layer.feature`",
    ...
    "body/hands": {
        "icon": "🖐️", "name": "The Hands", "role": "Shaper / Effector",
        "jadc2": "Decider / Effector", "gherkin": "`brain/prey_workflow.feature`",
    ...
    "body/blood": {
        "icon": "🩸", "name": "The Blood", "role": "Injector / Logistics",
        "jadc2": "Logistics", "gherkin": "`brain/gen50_core.feature`",
    ...
    "memory": {
        "icon": "💾", "name": "The Memory", "role": "Assimilator / Learner",
        "jadc2": "Intelligence", "gherkin": "`brain/memory_graphrag.feature`",
    ...
    "carapace": {
        "icon": "🛡️", "name": "The Carapace", "role": "Immunizer / Guardian",
        "jadc2": "Blue Team", "gherkin": "`brain/gen50_core.feature`",
    ...
    "venom": {
        "icon": "🧪", "name": "The Venom", "role": "Disruptor / Red Team",
        "jadc2": "Red Team", "gherkin": "`brain/swarm_workflow.feature`",
