...
hexagon:
  ontos:
    id: 714f427c-1894-4900-925b-15878b227b84
    type: md
    owner: Swarmlord
  chronos:
    status: active
    urgency: 0.5
    decay: 0.5
    created: '2025-11-23T10:21:31.373053+00:00'
  topos:
    address: body/hands/README.md
    links: []
  telos:
    viral_factor: 0.0
    meme: README.md
...
## 🧬 Biological Function
The **Hands** are the agents of **Change**. They write code, edit files, run terminal commands, and modify the environment.

## 📂 Contents
*   **Tools**: Python functions/classes.
*   **Agents**: Worker units.
