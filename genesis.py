...
def check_anatomy():
    ...
    try:
        ...
        console.print("[bold red]❌ CRITICAL: The Brain (brain/registry.yaml) is missing![/bold red]")
        sys.exit(1)
...
def check_environment():
    ...
    if in_venv:
        ...
        console.print("Virtual Environment: [yellow]Inactive (Recommended to use venv)[/yellow]")
